...
import com.faltenreich.releaseradar.ui.list.diffutil.ReleaseDiffUtilCallback
import com.faltenreich.releaseradar.ui.list.viewholder.ReleaseSearchViewHolder

class ReleaseSearchListAdapter(context: Context) : PagedListAdapter<Release, ReleaseSearchViewHolder>(context,
    ReleaseDiffUtilCallback()
) {
