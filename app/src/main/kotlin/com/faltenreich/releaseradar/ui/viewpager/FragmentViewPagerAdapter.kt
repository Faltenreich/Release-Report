...
class FragmentViewPagerAdapter(fragmentManager: FragmentManager?, private val content: List<Pair<String, Fragment>>) : FragmentStatePagerAdapter(fragmentManager) {
