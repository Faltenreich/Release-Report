...
import com.faltenreich.release.framework.android.decoration.ItemDecoration.Companion.SPACING_RES_DEFAULT
...
class ReleaseListFragment : BaseFragment(R.layout.fragment_release_list, R.menu.main),
    DatePickerOpener,
    SearchOpener {
    private val viewModel by lazy { createViewModel(ReleaseListViewModel::class) }
    private val date: LocalDate? by lazy { arguments?.let { arguments -> ReleaseListFragmentArgs.fromBundle(
        arguments
    ).date?.asLocalDate } }
