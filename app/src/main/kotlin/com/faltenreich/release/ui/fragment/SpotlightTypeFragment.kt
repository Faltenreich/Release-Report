...
import kotlinx.android.synthetic.main.fragment_spotlight_type.*

class SpotlightTypeFragment : BaseFragment(R.layout.fragment_spotlight_type), ReleaseOpener {
    ...
    companion object {
        ...
        fun newInstance(type: ReleaseType): SpotlightTypeFragment {
            val fragment = SpotlightTypeFragment()
