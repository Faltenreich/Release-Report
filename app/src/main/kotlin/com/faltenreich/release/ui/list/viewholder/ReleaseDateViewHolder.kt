...
class ReleaseDateViewHolder(context: Context, parent: ViewGroup) : BaseViewHolder<ListItem>(context, R.layout.list_item_release_date, parent) {

    override fun onBind(data: ListItem) {
