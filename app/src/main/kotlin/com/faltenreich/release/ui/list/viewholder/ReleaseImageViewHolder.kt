...
class ReleaseImageViewHolder(context: Context, parent: ViewGroup) : BaseViewHolder<ListReleaseItem>(context, R.layout.list_item_release_image, parent), ReleaseOpener {

    override fun onBind(data: ListReleaseItem) {
